...
from maxarcat_client.models.geo_json_multipolygon import GeoJSONMultipolygon  # noqa: E501
...
class TestGeoJSONMultipolygon(unittest.TestCase):
    ...
    def testGeoJSONMultipolygon(self):
        ...
        # model = maxarcat_client.models.geo_json_multipolygon.GeoJSONMultipolygon()  # noqa: E501
        pass
