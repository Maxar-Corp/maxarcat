...
from maxarcat_client.models.stac_extensions import StacExtensions  # noqa: E501
from maxarcat_client.rest import ApiException


class TestStacExtensions(unittest.TestCase):
    """StacExtensions unit test stubs"""
    ...
    def testStacExtensions(self):
        ...
        # model = maxarcat_client.models.stac_extensions.StacExtensions()  # noqa: E501
        pass
