...
from maxarcat_client.models.geo_json_geometry import GeoJSONGeometry  # noqa: E501
...
class TestGeoJSONGeometry(unittest.TestCase):
    ...
    def testGeoJSONGeometry(self):
        ...
        # model = maxarcat_client.models.geo_json_geometry.GeoJSONGeometry()  # noqa: E501
        pass
