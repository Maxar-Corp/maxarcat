...
from maxarcat_client.models.geo_json_multipoint import GeoJSONMultipoint  # noqa: E501
...
class TestGeoJSONMultipoint(unittest.TestCase):
    ...
    def testGeoJSONMultipoint(self):
        ...
        # model = maxarcat_client.models.geo_json_multipoint.GeoJSONMultipoint()  # noqa: E501
        pass
