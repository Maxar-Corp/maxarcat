...
class LimitFilter(object):
    ...
    def __init__(self, limit=None):  # noqa: E501
        """LimitFilter - a model defined in Swagger"""  # noqa: E501
        self._limit = None
    ...
    @property
    def limit(self):
        """Gets the limit of this LimitFilter.  # noqa: E501


        :return: The limit of this LimitFilter.  # noqa: E501
        :rtype: Limit
        """
        return self._limit
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LimitFilter, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LimitFilter):
            return False
