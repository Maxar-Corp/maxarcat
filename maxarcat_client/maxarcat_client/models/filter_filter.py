...
class FilterFilter(object):
    ...
    def __init__(self, filter=None):  # noqa: E501
        """FilterFilter - a model defined in Swagger"""  # noqa: E501
        self._filter = None
    ...
    @property
    def filter(self):
        """Gets the filter of this FilterFilter.  # noqa: E501


        :return: The filter of this FilterFilter.  # noqa: E501
        :rtype: Filter
        """
        return self._filter
    ...
    def filter(self, filter):
        """Sets the filter of this FilterFilter.


        :param filter: The filter of this FilterFilter.  # noqa: E501
        :type: Filter
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FilterFilter, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FilterFilter):
            return False
