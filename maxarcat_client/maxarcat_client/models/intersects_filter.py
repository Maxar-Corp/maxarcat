...
class IntersectsFilter(object):
    ...
    """
    swagger_types = {
        'intersects': 'OneOfintersectsFilterIntersects'
    }
    ...
    def __init__(self, intersects=None):  # noqa: E501
        """IntersectsFilter - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def intersects(self):
        """Gets the intersects of this IntersectsFilter.  # noqa: E501


        :return: The intersects of this IntersectsFilter.  # noqa: E501
        :rtype: OneOfintersectsFilterIntersects
        """
    ...
    def intersects(self, intersects):
        ...
        :type: OneOfintersectsFilterIntersects
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IntersectsFilter, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IntersectsFilter):
            return False
