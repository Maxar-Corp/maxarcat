...
class NextFilter(object):
    ...
    def __init__(self, next=None):  # noqa: E501
        """NextFilter - a model defined in Swagger"""  # noqa: E501
        self._next = None
    ...
    @property
    def next(self):
        """Gets the next of this NextFilter.  # noqa: E501


        :return: The next of this NextFilter.  # noqa: E501
        :rtype: Next
        """
        return self._next
    ...
    @next.setter
    def next(self, next):
        """Sets the next of this NextFilter.


        :param next: The next of this NextFilter.  # noqa: E501
        :type: Next
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NextFilter):
            return False
