...
class IdsFilter(object):
    ...
    def __init__(self, ids=None):  # noqa: E501
        """IdsFilter - a model defined in Swagger"""  # noqa: E501
        self._ids = None
    ...
    @property
    def ids(self):
        """Gets the ids of this IdsFilter.  # noqa: E501


        :return: The ids of this IdsFilter.  # noqa: E501
        :rtype: Ids
        """
        return self._ids
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IdsFilter):
            return False
